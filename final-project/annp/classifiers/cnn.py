...
class myCNN(object):
    ...
    def __init__(
        ...
        self.params['W1'] = np.random.randn(num_filters, C, filter_size, filter_size) * weight_scale
        self.params['b1'] = np.zeros(num_filters)
        self.params['W4'] = np.random.randn(num_filters, C, filter_size, filter_size) * weight_scale
    ...
    def loss(self, X, y=None):
        ...
        conv_relu_pool_out, conv_relu_pool_cache = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
        conv_relu_pool_out2, conv_relu_pool_cache2 = conv_relu_pool_forward(conv_relu_pool_out, W4, b4, conv_param, pool_param)
        affine_relu_out, affine_relu_cache = affine_relu_forward(conv_relu_pool_out2, W2, b2)
        # affine_relu_out2, affine_relu_cache2 = affine_relu_forward(affine_relu_out, W4, b4)
        scores, scores_cache = affine_forward(affine_relu_out, W3, b3)
        ...
        # loss += 0.5 * self.reg * (np.sum(W1 * W1) + np.sum(W2 * W2) + np.sum(W3 * W3))
        daffine_relu_out, dW3, db3 = affine_backward(dscores, scores_cache)
        # daffine_relu_out, dW4, db4 = affine_relu_backward(daffine_relu_out2, affine_relu_cache)
        dconv_relu_pool_out2, dW2, db2 = affine_relu_backward(daffine_relu_out, affine_relu_cache)
        dconv_relu_pool_out, dW4, db4 = conv_relu_pool_backward(dconv_relu_pool_out2, conv_relu_pool_cache)
        dx, dW1, db1 = conv_relu_pool_backward(dconv_relu_pool_out, conv_relu_pool_cache)
