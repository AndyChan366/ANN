...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        resof1st, cacheof1st = affine_relu_forward(X, self.params["W1"], self.params["b1"])
        resof2nd, cacheof2nd = affine_forward(resof1st, self.params["W2"], self.params["b2"])
        scores = resof2nd
        # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        ############################################################################
        #                             END OF YOUR CODE                             #
        ...
        dfc1, dW2, db2 = affine_backward(dscores, cacheof2nd)
        _, dW1, db1 = affine_relu_backward(dfc1, cacheof1st)
